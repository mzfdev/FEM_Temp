float calculate_local_area(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4){
    float A =  abs((x1*y2*z3 + x2*y3*z4 + x3*y4*z1) -
                     (x1*y3*z2 + x2*y4*z3 + x3*y1*z4) - 
                     (x1*y4*z3 + x2*y1*z4 + x3*y2*z1) + 
                     (x1*y2*z4 + x2*y3*z1 + x3*y4*z2) + 
                     (x1*y3*z4 + x2*y4*z2 + x3*y1*z3) -
                      (x1*y4*z2 + x2*y1*z3 + x3*y2*z4))/6;
